...
const StatsSection = () => {
  const flipAnimation1 = useFlipHookAnimaiton("animate-flipInX")
  return (
    <section className="text-center py-16 text-black bg-white">
      ...
      <div ref={flipAnimation1} className="flex flex-col lg:flex-row justify-center items-center space-y-4 lg:space-y-0 lg:space-x-4">
