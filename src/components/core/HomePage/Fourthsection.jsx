...
const features = [
  ...
  },
  {
    title: "Idea Sharing",
    description:
      "Share and explore innovative ideas with peers and instructors to foster a collaborative learning environment.",
    icon: FaLightbulb,
  },
];
      ...
      <section className="relative not-prose scroll-mt-[72px] text-white ">
        <div className="relative mx-auto px-4 lg:py-20 md:px-6 md:py-16 py-12 text-default max-w-7xl">
          <div className="text-center md:mx-auto mb-8 md:mb-10 lg:max-w-2xl max-w-xl sm:mx-auto">
            <p className="font-black text-sky-400 text-2xl text-heading uppercase">
              Features
            </p>
            <h2 className="font-bold leading-tight tracking-tighter text-4xl md:text-5xl text-heading mb-2">
              Unlock Your Potential with Institue with Engaging and Effective
              Learning!
            </h2>
          </div>
          ...
          <div className="mx-auto max-w-7xl md:px-8 p-4">
            <div className="lg:flex md:gap-16 lg:flex-row-reverse">
                    ...
                    <div key={index}>
                      <div className="flex flex-row max-w-none">
                        <div className="flex justify-center">
                          <feature.icon className="flex justify-center bg-[#ff0088]  text-white items-center h-7 mr-2 p-1 rounded-full w-7" />
                        </div>
                        <div className="mt-0.5">
                          <h3 className="font-medium dark:text-white leading-6 ml-2 text-lg">
                            {feature.title}
                          </h3>
                          <p className="text-richblack-200 ml-2 mt-1 ">
                            {feature.description}
                          </p>
                        </div>
                      </div>
              ...
              <div className="mx-auto md:basis-1/2 md:mt-0 mt-10" aria-hidden="true">
                <div className="relative mx-auto max-w-4xl">
                  <div className="w-[85vw] mx-auto lg:w-[550px]">
                    <Lottie
                      options={{
                        loop: true,
                        autoplay: true,
                        // path: "/lottie/darkThemeMove.json",
                        path: "/lottie/studyBoyGreen.json",
                      }}
                    />
                  </div>
                </div>
                    ...
                    <div className="flex items-center rtl:mr-0 flex-col mr-4 rtl:ml-4">
                      <div>
                        <div className="flex justify-center items-center">
                          <step.icon className="text-primary border-2 border-primary border-[#ff0088] text-white h-14 w-14 p-3 rounded-full" />
                        </div>
                      </div>
