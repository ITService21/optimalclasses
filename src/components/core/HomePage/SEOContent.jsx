...
const SEOContent = () => {
  ...
  const courses = [
    {
      title: "Class 7 to class 10 CBSE, ICSE and ISC Coaching",
      desc: "We provide comprehensive Class 7 to class 10 CBSE coaching in Varanasi, focusing on concept clarity, NCERT coverage and exam-oriented preparation.",
      icon: "📚",
      link: "/class-7t10"
    },
    {
